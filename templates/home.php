    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li>
                    <a href="templates/categories.php" class="nav-link px-2 text-white d-flex align-items-center column-gap-2">
            ...
            <div class="d-flex align-items-center text-end">
                <a href="templates/login.php" type="button" class="btn btn-outline-light me-2 d-flex align-items-center column-gap-2">
                ...
                <a href="templates/register.php" type="button" class="btn btn-warning d-flex align-items-center column-gap-2">
